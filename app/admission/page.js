...
const COPY = {
  ru: {
    ...
    sub: 'Всё, что нужно знать о поступлении в КГУ',
    process: 'Процесс',
    processTitle: 'Как поступить в КГУ',
    finance: 'Финансирование',
    financeTitle: 'Стипендии и гранты',
    financeSub: 'Мы стремимся сделать качественное образование доступным для каждого',
    faqLabel: 'Вопросы',
    faqTitle: 'Часто задаваемые вопросы',
    ctaTitle: 'Готов стать студентом КГУ?',
    ctaSub: 'Подай заявку сейчас и начни своё академическое путешествие. Мы ответим в течение 24 часов.',
    ...
    faq: [
      ...
      { q: 'Есть ли бюджетные места?', a: 'Да, КГУ предоставляет государственные гранты (бюджетные места). Количество грантов по каждому факультету определяется ежегодно Министерством образования.' },
  ...
  kg: {
    ...
    title: '2025-жылдагы кабыл алуу өнөктүгү',
    sub: 'КМУга тапшыруу тууралуу билишиңиз керек болгон бардык маалымат',
    process: 'Процесс',
    processTitle: 'КМУга кантип тапшыруу керек',
    finance: 'Каржылоо',
    financeTitle: 'Стипендиялар жана гранттар',
    financeSub: 'Биз сапаттуу билимди ар бир адам үчүн жеткиликтүү кылууга умтулабыз',
    faqLabel: 'Суроолор',
    faqTitle: 'Көп берилүүчү суроолор',
    ctaTitle: 'КМУнун студенти болууга даярсызбы?',
    ctaSub: 'Азыр арыз бериңиз жана академиялык жолуңузду баштаңыз. Биз 24 саат ичинде жооп беребиз.',
    ...
    faq: [
      ...
      { q: 'Бюджеттик орундар барбы?', a: 'Ооба, КМУ мамлекеттик гранттарды сунуштайт. Ар бир факультет боюнча гранттардын саны жыл сайын Билим берүү министрлиги тарабынан аныкталат.' },
  ...
  en: {
    label: 'Applicants',
    title: 'Admissions campaign 2025',
    sub: 'Everything you need to know about applying to KSU',
    process: 'Process',
    processTitle: 'How to apply to KSU',
    finance: 'Funding',
    financeTitle: 'Scholarships and grants',
    financeSub: 'We strive to make quality education accessible to everyone',
    faqLabel: 'Questions',
    faqTitle: 'Frequently asked questions',
    ctaTitle: 'Ready to become a KSU student?',
    ctaSub: 'Apply now and start your academic journey. We will respond within 24 hours.',
    ...
    faq: [
      ...
      { q: 'Are there budget places?', a: 'Yes, KSU provides state grants (budget places). The number of grants per faculty is determined annually by the Ministry of Education.' },
